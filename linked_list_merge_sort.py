...
def merge(left, right):
    """
    Merges two linked lists sorting by data in the node
    ...
    # Iterates over left and right until we reach the tail node
    # of either
    while left_head or right_head:
        ...
        if left_head is None:
            ...
            # If data on left is less than right, set the current to left node
